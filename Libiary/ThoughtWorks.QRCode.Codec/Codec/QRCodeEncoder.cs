using SP.StudioCore.Libiary.ThoughtWorks.QRCode.Codec.Properties;
using System;
    ...
    public class QRCodeEncoder
    {
        ...
        public virtual bool[][] calQrcode(byte[] qrcodeData)
        {
            ...
            try
            {
                ...
                byte[] bytes = (byte[]?)Resources.ResourceManager.GetObject(name) ?? Array.Empty<byte>();
            ...
            try
            {
                ...
                MemoryStream memoryStream = new MemoryStream(((byte[]?)Resources.ResourceManager.GetObject(name) ?? Array.Empty<byte>()));
                BufferedStream bufferedStream = new BufferedStream(memoryStream);
