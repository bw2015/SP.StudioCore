...
{
    public class SpJsonConsole : ConsoleFormatter, IDisposable
    {
        /// <summary>
        /// 释放
        /// </summary>
        ...
        /// 当配置改变时，自动重读
        /// </summary>
        public SpJsonConsole(IOptionsMonitor<JsonConsoleFormatterOptions> options) : base("json")
        {
        ...
        public override void Write<TState>(in LogEntry<TState> logEntry, IExternalScopeProvider scopeProvider, TextWriter textWriter)
        {
            ...
            using (Utf8JsonWriter writer = new(byteBufferWriter, this.FormatterOptions.JsonWriterOptions))
                //using (Utf8JsonWriter writer = new(byteBufferWriter, new JsonWriterOptions { }))
            {
                ...
                writer.WriteString("Category", category.Split('.')[^1]);
            ...
            var content = Encoding.UTF8.GetString(byteBufferWriter.WrittenMemory.Span);
        ...
        private void WriteItem(Utf8JsonWriter writer, KeyValuePair<string, object> item)
        {
            ...
            switch (item.Value)
            {
                ...
                case sbyte num2:
                    ...
                    break;
                case char reference:
                    writer.WriteString(key, MemoryMarshal.CreateSpan(ref reference, 1));
                    break;
                case Decimal num3:
        ...
        private void WriteScopeInformation(Utf8JsonWriter writer, IExternalScopeProvider scopeProvider)
        {
            ...
            scopeProvider.ForEachScope((Action<object, Utf8JsonWriter>) ((scope, state) =>
            {
