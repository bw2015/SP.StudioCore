...
namespace SP.StudioCore.MQ.Configs
{
    public interface IRabbitManager
    {
        ...
        void CreateExchange(string exchangeName, ExchangeType exchangeType, bool durable = true,
        ...
        /// <param name="autoDelete">是否自动删除（默认false）</param>
        /// <param name="arguments">队列参数</param>
        void CreateQueueAndBind(string queueName, string exchangeName, string routingKey, bool durable = true,
