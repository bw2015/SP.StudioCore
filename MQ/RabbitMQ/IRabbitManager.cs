...
namespace SP.StudioCore.MQ.RabbitMQ
{
    ...
    public interface IRabbitManager
    {
        ...
        void CreateExchange(string exchangeName, ExchangeType exchangeType, bool durable = true, bool autoDelete = false, IDictionary<string, object> arguments = null);
        ...
        /// <param name="autoDelete">是否自动删除（默认false）</param>
        /// <param name="arguments">参数</param>
        void CreateExchange(ExchangeType exchangeType, bool durable = true, bool autoDelete = false, IDictionary<string, object> arguments = null);
    }
}